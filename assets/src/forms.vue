            ...
            <div class="w-full">
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        ...
                        <div class="gap gap-6 w-full flex py-1" v-if="Agents">
                            <label class="w-full col-form-label">Agent</label>
                            <div class="w-full">
                                <select class=" w-full form-control border rounded-lg border-gray-200 px-2" v-model="Property.agent_id">
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        <div class="gap gap-6 w-full flex py-1" v-for="(value,i) in Property.spaces_fields">
                            <label class="w-full col-form-label" v-text="value"></label>
                            <div class="w-full">
                                <input type="text" class="w-full form-control border rounded-lg border-gray-200 px-2" v-model="Property.spaces[i]">
                            </div>
                        </div>
